1. Entity in Spring Boot is a proxy: Using in lazy loading, optimize performance app. JPA creates proxy for entity, proxy saves info of entity but don't have data from db
